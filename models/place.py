...
class Place(BaseModel, Base):
    ...
    Attributes:
        __tablename__ (str): The name of the table that stores places.
        city_id (sqlalchemy String): The city id.
        user_id (sqlalchemy String): The user id.
        name (sqlalchemy String): The name.
        description (sqlalchemy String): The description.
        number_rooms (sqlalchemy Integer): The number of rooms available.
        ...
        latitude (sqlalchemy Float): The latitude.
        longitude (sqlalchemy Float): The longitude.
